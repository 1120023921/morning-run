...
public class ExcelUtil {
     ...
     * @throws              1.先用InputStream获取excel文件的io流
        ...
        for (int numSheet = 0; numSheet < size; numSheet++) {
            ...
            for (int rowNum = 1; rowNum <= hssfSheet.getLastRowNum(); rowNum++) {
                ...
                for (int colIx = minColIx; colIx < maxColIx; colIx++) {
                    ...
                    rowList.add(getHSSFCellStringVal(cell));
                }
                result.add(rowList);
            }
        }
        ...
        for (XSSFSheet xssfSheet : xssfWorkbook) {
            ...
            for (int rowNum = 1; rowNum <= xssfSheet.getLastRowNum(); rowNum++) {
                ...
                for (int colIx = minColIx; colIx < maxColIx; colIx++) {
                    ...
                    rowList.add(getXSSFCellStringVal(cell));
                }
                result.add(rowList);
            }
        }
     ...
     */
    public static String getHSSFCellStringVal(HSSFCell cell) {
     ...
     * 2.如果是数字，则修改单元格类型为String，然后返回String，这样就保证数字不被格式化了
     */
    public static String getXSSFCellStringVal(XSSFCell cell) {
        switch (cell.getCellType()) {
            case Cell.CELL_TYPE_BOOLEAN:
                return cell.getBooleanCellValue() ? "TRUE" : "FALSE";
            case Cell.CELL_TYPE_FORMULA:
